	...
	<tr>
		<td align="right">
				<select name="searchCondition" class="ct_input_g" style="width:80px">
					...
					<option value="0" ${!empty search.searchCondition && search.searchCondition == 0} >상품번호</option>
					<option value="1" ${!empty search.searchCondition && search.searchCondition == 1 }>상품명</option>
					<option value="2" ${!empty search.searchCondition && search.searchCondition == 2 }>상품가격</option>
				</select>
